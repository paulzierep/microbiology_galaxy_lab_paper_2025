...
gr1_df$Topics <- ifelse(
    gr1_df$Topics == "All", "Non microbial-related",
    ifelse(
        gr1_df$Topics == "", "Unlabeled microbial-related",
        gr1_df$Topics
    )
)
...
gr1_df$Topics <- gr1_df$Topics |> factor(levels = c("Ecosystem Dynamics & Biodiversity",
                                                    ...
                                                    "Health & Disease",
                                                    "Unlabeled microbial-related",
                                                    "Non microbial-related"))
...
gr1 <- gr1_df |>
    ...
    scale_fill_manual(values = c("Non microbial-related" = "grey" |> lighten(.25),
                                 "Unlabeled microbial-related" = "#6abd66" |> darken(.1),
